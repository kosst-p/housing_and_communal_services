...
router.post( '/transactions', middlewares.validationJwt, controller.createTransaction ); // validate
router.patch( '/transactions/:id', middlewares.validationJwt, controller.updateTransaction ); // validate
